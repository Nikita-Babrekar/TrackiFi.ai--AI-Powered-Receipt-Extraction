...
#         prompt = "Analyze this receipt image. Extract the vendor name, date, total amount, and categorize the expense."
...
#         # 4. Grab the cleanly parsed JSON response object directly from the SDK
#         extracted_data = response.parsed

#         # 5. Send the structured data safely back to the frontend
#         return jsonify({
#             "success": True,
#             "data": {
